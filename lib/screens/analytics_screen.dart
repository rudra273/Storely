  ...
  return FutureBuilder<T>(
    ...
    builder: (_, snap) {
      if (snap.connectionState != ConnectionState.done) {
        return KpiLoadingCard(title: title);
      }
...
class _SalesSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        // Total Revenue + AOV
        _futureKpi('Total Revenue', db.kpiTotalRevenue(from: from, to: to), (
          v,
        ) {
          return KpiCard(
            title: 'TOTAL REVENUE',
        ...
        _futureKpi(
          'Average Order Value',
          db.kpiAverageOrderValue(from: from, to: to),
          (v) {
            return KpiCardRow(
              left: KpiCard(
        ...
        _futureKpi(
          'Revenue Trend',
          db.kpiDailyRevenueTrend(from: from, to: to),
          (rows) {
            final data = rows
                .map(
                  (r) => (
        ...
        _futureKpi(
          ...
          db.kpiRevenueByPaymentMethod(from: from, to: to),
          (rows) {
            final segs = rows
                .asMap()
                .entries
        ...
        // Discount rate
        _futureKpi('Discount Rate', db.kpiDiscountRate(from: from, to: to), (
          v,
        ) {
          return KpiGaugeCard(
            title: 'Discount Rate',
        ...
        _futureKpi(
          'Revenue by Category',
          db.kpiRevenueByCategory(from: from, to: to),
          (rows) {
            final items = rows
                .map(
                  (r) => (
        ...
        _futureKpi(
          'Busy Day of Week',
          db.kpiBusyDayOfWeek(from: from, to: to),
          (rows) {
  ...
  Widget _futureAovRight(DatabaseHelper db, String? from, String? to) {
    return _futureKpi('Discount Rate', db.kpiDiscountRate(from: from, to: to), (
      v,
    ) {
      return KpiCard(
        title: 'DISCOUNT RATE',
    ...
    return Column(
      ...
      children: [
        ...
        _futureKpi('Gross Profit', db.kpiGrossProfit(from: from, to: to), (gp) {
          return _futureKpi(
            'Gross Margin',
            db.kpiGrossMarginPercent(from: from, to: to),
            (margin) {
              return KpiCardRow(
                left: KpiCard(
                  title: 'GROSS PROFIT',
        ...
        _futureKpi(
          'Commission & Net Profit',
          db.kpiTotalCommissionPaid(from: from, to: to),
          (comm) {
            return _futureKpi(
              'Net Profit',
              db.kpiNetProfitAfterCommission(from: from, to: to),
              (net) {
                return KpiCardRow(
                  left: KpiCard(
        ...
        _futureKpi(
          'Profit Trend',
          db.kpiMonthlyProfitTrend(from: from, to: to),
          (rows) {
            final data = rows
                .map(
                  (r) => (
        ...
        // GST collected
        _futureKpi('GST Collected', db.kpiGstCollected(from: from, to: to), (
          v,
        ) {
          return KpiCard(
            title: 'GST COLLECTED',
        ...
        _futureKpi(
          'Top Profit Items',
          db.kpiTopProfitItems(from: from, to: to),
          (rows) {
            final items = rows
                .map(
                  (r) => (
        ...
        _futureKpi(
          'Low Margin Items',
          db.kpiTopNonProfitItems(from: from, to: to),
          (rows) {
            final items = rows
                .map(
                  (r) => (
        ...
        _futureKpi(
          'Profit by Category',
          db.kpiProfitByCategory(from: from, to: to),
          (rows) {
            final items = rows
                .map(
                  (r) => (
    ...
    return Column(
      ...
      children: [
        ...
        _futureKpi('Active Customers', db.kpiTotalActiveCustomers(), (active) {
          return _futureKpi('New Customers', db.kpiNewCustomersAcquired(), (
            newC,
          ) {
            return KpiCardRow(
              left: KpiCard(
        ...
        // Avg CLV + Avg bills
        _futureKpi('Avg Lifetime Value', db.kpiAvgCustomerLifetimeValue(), (
          clv,
        ) {
    ...
    return Column(
      ...
      children: [
        ...
        _futureKpi(
          ...
          db.kpiTop10ProductsByRevenue(from: from, to: to),
          (rows) {
            final items = rows
                .map(
                  (r) => (
        ...
        _futureKpi(
          ...
          db.kpiTop10ProductsByQuantity(from: from, to: to),
          (rows) {
            final items = rows
                .map(
                  (r) => (
        ...
        _futureKpi('New Products', db.kpiNewProductsAdded(), (v) {
          return _futureKpi(
            'Price Compliance',
            db.kpiProductPriceCompliance(from: from, to: to),
            (pct) {
              return KpiCardRow(
                left: KpiCard(
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        _futureKpi('Bills Per Day', db.kpiBillsPerDay(from: from, to: to), (
          bpd,
        ) {
          return _futureKpi(
            'Avg Items',
            db.kpiAvgItemsPerBill(from: from, to: to),
            (avg) {
              return KpiCardRow(
                left: KpiCard(
                  title: 'BILLS PER DAY',
        ...
        _futureKpi('Devices', db.kpiMultiDeviceActivity(from: from, to: to), (
          devices,
        ) {
